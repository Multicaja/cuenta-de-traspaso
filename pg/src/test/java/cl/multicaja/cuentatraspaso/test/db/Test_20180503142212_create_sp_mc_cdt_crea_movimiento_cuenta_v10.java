  ...
  private List getCuentaAcumulador(long idCuenta, long idFase) {
    ...
    sQuery =
      "select\n" +
        ...
        " inner join " + getSchema() + "." + Constants.Tables.REGLA_ACUMULACION.getName() + " rac on rac.id = cac.id_regla_acumulacion\n" +
        " inner join " + getSchema() + "." + Constants.Tables.FASE_ACUMULADOR.getName() + " fac on fac.id_regla_acumulacion = cac.id_regla_acumulacion and\n" +
